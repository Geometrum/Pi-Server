...
echo '' >> /var/www/update-SSL.sh
echo 'openssl req -newkey rsa:2048 -nodes -keyout /etc/apache2/SSL/SSL.key -x509 -days 365 -out /etc/apache2/SSL/SSL.crt' > /var/www/update-SSL.sh
...
echo '	SSLCertificateFile /etc/apache2/SSL/SSL.crt' >> /etc/apache2/sites-available/SSL-local.conf
echo '	SSLCertificateKeyFile /etc/apache2/SSL/SSL.key' >> /etc/apache2/sites-available/SSL-local.conf
...
echo '	SSLCertificateFile /etc/apache2/SSL/SSL.crt' >> /etc/apache2/sites-available/SSL-cloud.conf
echo '	SSLCertificateKeyFile /etc/apache2/SSL/SSL.key' >> /etc/apache2/sites-available/SSL-cloud.conf
...
echo '# SSL protocol for phpmyadmin requests' > /etc/apache2/sites-available/SSL-phpmyadmin.conf
echo '<VirtualHost *:443>' >> /etc/apache2/sites-available/SSL-phpmyadmin.conf
echo "	ServerName phpmyadmin.$domain.$tld" >> /etc/apache2/sites-available/SSL-phpmyadmin.conf
echo '	DocumentRoot /usr/share/phpmyadmin' >> /etc/apache2/sites-available/SSL-phpmyadmin.conf
echo '	SSLEngine On' >> /etc/apache2/sites-available/SSL-phpmyadmin.conf
echo '	SSLCertificateFile /etc/apache2/SSL/SSL.crt' >> /etc/apache2/sites-available/SSL-phpmyadmin.conf
echo '	SSLCertificateKeyFile /etc/apache2/SSL/SSL.key' >> /etc/apache2/sites-available/SSL-phpmyadmin.conf
echo '</VirtualHost>' >> /etc/apache2/sites-available/SSL-phpmyadmin.conf
ln -s /etc/apache2/sites-available/SSL-phpmyadmin.conf /etc/apache2/sites-enabled/SSL-phpmyadmin.conf
...
echo '	Alias /cloud /var/www/cloud' >> /etc/apache2/sites-available/SSL-phpmyadmin.conf
echo '	Alias /phpmyadmin /usr/share/phpmyadmin' >> /etc/apache2/sites-available/SSL-phpmyadmin.conf
echo '	SSLEngine On' >> /etc/apache2/sites-available/SSL.conf
echo '	SSLCertificateFile /etc/apache2/SSL/SSL.crt' >> /etc/apache2/sites-available/SSL.conf
echo '	SSLCertificateKeyFile /etc/apache2/SSL/SSL.key' >> /etc/apache2/sites-available/SSL.conf
echo '</VirtualHost>' >> /etc/apache2/sites-available/SSL.conf
...
echo 'Do not forget to open/redirect 80/443 ports'
